...
>
  ...
  <Export columnVisibility={columnVisibility} COLUMNS={COLUMNS} filteredRows={filteredRows} pdfTitle={"GEOFENCES LIST"} pdfFilename={"Geofences.pdf"} excelFilename={"Geofences.xlsx"} prevColor={prevColor}/>
